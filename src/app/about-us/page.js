        ...
        <>
            ...
            >
                ...
                <div className='pt-[30%] md:pt-[15%] lg:pt-[10%] pb-20'>
                    ...
                    <p className='text-black text-[1rem] text-center w-[95%] md:w-[70%] mx-auto'>We are the most leading multimedia company that is renowned for developing top-notch <a href='/screen-recorder'>screen recording</a>, <a href='/game-recorder'>game recording</a>, and <a href='/webcam-recorder'>webcam recording.</a> We aim to make suitable software which is very easy to use and help you in your projects professionally. It has some great features like you can draw in real-time which is best for educational and presentation videos. There you can also blur that particular part and hide your sensitive information. It is very easy to use and has a fast video-cutting program where you can trim any part of your video while keeping its original quality. The best part is while recording it does not slow down your desktop and it is free to use. So what are you doing? downloading the extension now and start recording.</p>
                </div>
            </div>
            <Footer />
        </>
