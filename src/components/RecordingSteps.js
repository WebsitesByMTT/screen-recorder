...
const RecordingSteps = () => {
  const data = [
    {
      ...
      arrow: (
        ...
        >
          <path
            d="M0.0602212 6C0.0602212 8.94552 2.44804 11.3333 5.39355 11.3333C8.33907 11.3333 10.7269 8.94552 10.7269 6C10.7269 3.05448 8.33907 0.666667 5.39355 0.666667C2.44804 0.666667 0.0602212 3.05448 0.0602212 6ZM356.394 116L362.167 106H350.62L356.394 116ZM5.39355 7H347.394V5H5.39355V7ZM355.394 15V107H357.394V15H355.394ZM347.394 7C351.812 7 355.394 10.5817 355.394 15H357.394C357.394 9.47715 352.916 5 347.394 5V7Z"
            fill="#230346"
          />
        </svg>
      ),
    },
    {
      icon: (
        ...
        >
          <path
            d="M20.3933 37.5C23.9103 37.5062 27.3468 36.447 30.2502 34.4621C30.3768 34.3757 30.5191 34.315 30.6691 34.2836C30.8191 34.2522 30.9738 34.2507 31.1244 34.2791C31.275 34.3074 31.4185 34.3652 31.5467 34.4491C31.675 34.5329 31.7855 34.6412 31.8719 34.7678C31.9583 34.8943 32.019 35.0366 32.0504 35.1866C32.0818 35.3366 32.0833 35.4913 32.0549 35.6419C32.0266 35.7925 31.9688 35.936 31.8849 36.0643C31.8011 36.1926 31.6928 36.3031 31.5662 36.3895L31.5662 36.3895C28.2751 38.639 24.3802 39.8396 20.3938 39.8333H20.3936C9.44027 39.8333 0.560221 30.9533 0.560221 20C0.560221 9.04671 9.44027 0.166667 20.3936 0.166667C31.3468 0.166667 40.2269 9.04671 40.2269 20C40.2269 22.5936 39.7279 25.1198 38.7707 27.4723L38.7695 27.4753L37.7269 20H37.8936C37.8936 19.9999 37.8936 19.9998 37.8936 19.9998C37.8934 10.3345 30.0589 2.5 20.3936 2.5C10.7282 2.5 2.89355 10.3346 2.89355 20C2.89355 29.6653 10.728 37.4998 20.3933 37.5ZM20.3933 37.5L20.3936 37.3333M20.3933 37.5C20.3934 37.5 20.3935 37.5 20.3936 37.5V37.3333M20.3936 37.3333C23.877 37.3394 27.2806 36.2904 30.1562 34.3244M20.3936 37.3333L30.1562 34.3244M30.1562 34.3244C30.3008 34.2257 30.4635 34.1564 30.6349 34.1205C30.8063 34.0846 30.9831 34.0828 31.1552 34.1153C31.3273 34.1477 31.4914 34.2137 31.6379 34.3096C31.7845 34.4054 31.9108 34.5291 32.0096 34.6738C32.1083 34.8184 32.1776 34.9811 32.2135 35.1525C32.2494 35.3239 32.2512 35.5007 32.2187 35.6728C32.1863 35.8449 32.1203 36.0089 32.0244 36.1555C31.9286 36.3021 31.8048 36.4284 31.6602 36.5271C28.3414 38.7956 24.4136 40.0063 20.3936 40C9.34822 40 0.393555 31.0453 0.393555 20C0.393555 8.95467 9.34822 0 20.3936 0C31.4389 0 40.3936 8.95467 40.3936 20C40.3936 22.6151 39.8904 25.1627 38.9251 27.5351L30.1562 34.3244Z"
            fill="url(#paint0_linear_242_1178)"
            stroke="#B6A4E6"
            stroke-width="0.333333"
          />
          <path
            d="M20.3934 14.666C23.9489 14.666 25.7267 16.4438 25.7267 19.9993C25.7267 23.5549 23.9489 25.3327 20.3934 25.3327C16.8378 25.3327 15.0601 23.5549 15.0601 19.9993C15.0601 16.4438 16.8378 14.666 20.3934 14.666Z"
            fill="url(#paint1_linear_242_1178)"
          />
          <defs>
            <linearGradient
              id="paint0_linear_242_1178"
              x1="20.3936"
              y1="0"
              x2="20.3936"
              y2="40"
  ...
  return (
    <div className="bg-white px-5 py-5 lg:py-10 lg:px-14 ">
      <div className=" ">
        <h2 className="text-black text-[2.5rem] md:text-[3.5rem] pb-3 md:pb-16 text-center">
          How to screen record
        </h2>
        {data.map((item, ind) => (
          <div
            className="w-full md:w-[90%] px-4 md:px-0 grid grid-cols-12 py-4 md:py-6 mx-auto "
            key={ind}
          >
            <div
              key={ind}
            ...
            >
              <div
                className={`md:flex md:space-x-10  justify-between ${
                  ind % 2 === 1 ? "md:flex-row-reverse" : ""
                }  items-center`}
              >
                ...
                <div className="text-[1.2rem] pt-2 md:pt-0 w-[100%] md:w-[75%]">
                  {item.text}
                </div>
              </div>
            </div>
            ...
            <div
              className={`md:block hidden col-span-5  ${
