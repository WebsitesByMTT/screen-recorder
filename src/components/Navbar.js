    ...
    <>
      <div className=" p-5 lg:px-14 lg:pt-8 absolute top-0 left-0 w-full z-50 ">
        <div className="flex items-center justify-between ">
          ...
          >
            <span
              className={`absolute block h-[2px] w-full bg-white transform rotate-0 transition-all duration-100 ease-in-out top-0 ${isOpen && " top-[7px] rotate-[135deg]"
                }`}
            ></span>
            <span
              className={`absolute block h-[2px] w-full bg-white transform rotate-0 transition-all duration-100 ease-in-out top-2 ${isOpen && " hidden"
                }`}
            ></span>
            <span
              className={`absolute block h-[2px] w-full bg-[white] transform rotate-0 transition-all duration-100 ease-in-out top-4 ${isOpen && " top-[7px] rotate-[-135deg]"
                }`}
            ></span>
          </div>
        </div>

        <div className={`bg-gradient-to-r from-[#120A41] to-[#5329C4] absolute left-0 top-0 w-full ${isOpen ? 'h-[50vh] transition-all  p-4' : 'h-[0vh] transition-all'}  flex items-center justify-center rounded-b-3xl lg:hidden`}>
          {isOpen && <ul className="  flex items-center flex-col justify-center gap-4">
            ...
            <li>
              <Link href={'/blogs'} className=" text-white text-base cursor-pointer">
                Blog
              </Link>
            </li>
            <li>
              <button className=" border border-white rounded-3xl flex items-center px-4 py-2">
                ...
                <a href="https://chromewebstore.google.com/detail/screen-recorder/hnpejnkkepgblnblidhfklgclddbnoaa" target="_blank" className=" text-white text-base">
