...
const FreeScreenRecorder = () => {
  ...
  return (
    <div className='bg-white pt-20'>
      <div className='text-black text-center pb-12 text-[2rem] md:text-[3rem]'>Features of Free Screen Recorder</div>
              ...
              <div key={index} className="slide">
                <div className='bg-gradient-to-t rounded-3xl p-[1px] from-[#5329C4] to-[#B6A4E6] col-span-12 md:col-span-4'>
                  <div className='bg-white w-[350px] px-2 md:px-4 pt-2 pb-4 rounded-3xl'>
                    ...
                    <div className='text-[1rem] text-center text-black'>{item.title}</div>
                    <div className='text-black text-center text-[.9rem] pt-3'>{item.para}</div>
                  </div>
                </div>
              </div>
            ))}
