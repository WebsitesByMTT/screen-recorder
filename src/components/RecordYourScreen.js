...
const RecordYourScreen = () => {
  return (
    <div className='pt-10 md:pt-24 md:pb-12'>
      <div className='bg-[#E2D7FF] md:px-20 py-12 rounded-[2rem] md:w-[90%] mx-auto border'>
...
export default RecordYourScreen
